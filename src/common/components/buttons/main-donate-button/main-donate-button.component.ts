...
@Component({
  ...
  template: `
    <a target="_blank"
       href="https://donorbox.org/ukraine-matters-life-is-the-greatest-value"
       class="w-full min-w-[340px] h-[70px] px-[18px] bg-[#1f2024] justify-center items-center gap-[7px] inline-flex cursor-pointer">
