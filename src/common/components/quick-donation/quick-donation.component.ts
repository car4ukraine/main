...
@Component({
  ...
  template: `
    ...
    <div>
      <iframe src="https://donorbox.org/embed/quick-donation-c4u?designation=Upgrade%20donated%20cars&default_interval=o" name="donorbox" allowpaymentrequest="allowpaymentrequest" seamless="seamless" frameborder="0" scrolling="no" height="900px" width="100%" style="max-width: 500px; min-width: 250px; max-height:none!important" allow="payment">
